...
class LMSMenuHandler(object):
    ...
    Menus can be requested via the get_home_menu or get_custom_menu methods. \
    Subsequent menus are generated by getting the menu command from previous \
    menus and passing it to the get_menu method.
    ...
    @staticmethod
    def _is_playable(item, base=None):
